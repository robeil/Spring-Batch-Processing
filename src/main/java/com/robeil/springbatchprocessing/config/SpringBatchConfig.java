package com.robeil.springbatchprocessing.config;

import com.robeil.springbatchprocessing.entity.Customer;
import com.robeil.springbatchprocessing.repository.CustomerRepository;
    ...
    public FlatFileItemReader<Customer> reader() {
        ...
        public Step step1(){
            return stepBuilderFactory
                    .get("csv-step").<Customer, Customer>chunk(10)
                    .reader(reader())
                    .processor(processor())
                    .writer(writer())
